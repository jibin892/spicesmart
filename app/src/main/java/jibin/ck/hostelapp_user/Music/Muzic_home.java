...
public class Muzic_home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_muzic_home);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(FragmentMusicSong.newInstance(), "ALBUMS");
        adapter.addFragment(FragmentMusicSong.newInstance(), "ARTISTS");
